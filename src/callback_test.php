...
**/
    ...
    define ("CALLBACK_WSDL", $CFG->wwwroot."/blocks/pageone/callback.php?wsdl");

    /*****This must be set to point at your callback server*****/
    define ("CALLBACK_SERVER", $CFG->wwwroot."/blocks/pageone/callback.php");
    ...
    /***The new PageOne WSDL refuses to work with the proxy class methods, so use this instead***/
    if (array_key_exists("action", $_POST))
    {
        if ($_POST['action']=="reply")
        {
            echo "<p>Sending message</p>";
            send_callback("onMessageReceived", get_message_body($_POST['source'], $_POST['destination'], $_POST['text']));
        } 
        else
    ...
    **/
    ...
    {
        return "<onDeliveryReport xmlns=\"http://jaxb.liquidcallback.pageone.com\"><report>\n"
            ."<source>".$source."</source>\n"
            ."<destination>".$destination."</destination>\n"
            ."<receiptTime>".get_time()."</receiptTime>\n"
            ."<resultCode>".$result."</resultCode>\n"
            ."<transactionID>".$id."</transactionID>\n"
            ."</report></onDeliveryReport>\n";
    }
    ...
    **/
    ...
    function get_message_body($source, $destination, $text)
    {
        return "<onMessageReceived xmlns=\"http://jaxb.liquidcallback.pageone.com\"><message>\n"
            ."<source>".$source."</source>\n"
            ."<destination>".$destination."</destination>\n"
            ."<messageTime>".get_time()."</messageTime>\n"
            ."<text>".$text."</text>\n"
