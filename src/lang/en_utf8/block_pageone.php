...
$string['callback_instructions'] = 'In order to recieve incomming text messages and text message delivery reports, you need to register a callback '.
 'service with PageOne. The callback URL for this Moodle server which should be sent to PageOne support is shown below:';
...
$string['config_alpha_tag_help'] = 'The default number which all text messages sent from this system will come from. This can be overridden '.
 ' by the custom MSISDN settings.';
...
$string['config_mobile_find_help'] = "This setting controls the mechanism used to identify Mobile phone numbers in the Moodle user ".
 "parameters. The options are:<br /><ul>".
 "<li><b>Moodle 'Mobile Phone' user parameter:</b> The reccomended option if your user database is consistent and the mobile phone ".
 "number is never placed in the other field. (Note this was refered to as 'Phone 2' in some older versions of Moodle).</li>".
 "<li><b>Moodle 'Phone' user parameter:</b> Uses the number in the 'Phone' user parameter field. (Note this was refered to as 'Phone 1' ".
 "in some older versions of Moodle)</li>".
 "<li><b>First valid phone number:</b> This will check both the 'Phone' and 'Mobile Phone' fields. If 'Phone' contains a valid number, then ".
 " this will be used. If not, the content of 'Mobile phone' will be used.</li>".
 "<li><b>Second valid phone number:</b> This will check both the 'Mobile Phone' and 'Phone' fields. If 'Mobile Phone' contains a valid number, then ".
 " this will be used. If not, the content of 'Phone' will be used.</li>".
 "<li><b>Automatically identify UK mobile phone number:</b> This method checks all phone numbers stored in the users profile to see if they start ".
 " with the normal UK mobile phone number prefix, 07.</li>".
 "<li><b>Mobile phone number prefixed with letter m:</b> Use this option if the mobile phone number is stored prefixed with an m (eg m07123 456789) ".
 "in either phone number field </li></ul>";
...
$string['more_users'] = "The users list shows all the users who have permission to use all the MoodleMobile instances on this system. ".
 "If you have used a single sticky or site-wide instance of MoodleMobile instead of adding it to the courses where required, then you may ".
 "find that many users are missing from the user list. When using MoodleMobile in this way, you will need to give any user you wish to be able ".
 " to send or recieve messages site-wide 'can send' permission.";
...
$string['no_list'] = "The MSISDN list could not be retrieved. If you are installing this block for the first time, leave this setting blank ".
 "for now and the return to the block configuration page after the other settings have been saved to see the list of available MSISDNs. ".
 "If the block has already been installed, then please check the account number and password settings.";
...
$string['select_help'] = 'Hold down the CTRL key to make multiple selections from the user lists, or to select/unselect individual users.'.
 ' If you want to select all the items in a list quickly, just click the top item and drag down.';
$string['soap_fault'] = 'SOAP connection fault';
$string['soap_fault_help'] = 'This problem might be due to network problems or a bug in the MoodleMobile block or the services it is attempting to connect to.'.
                        ' If the problem persists, please report it to your system administrator with a copy of this error message.';
