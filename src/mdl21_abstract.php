...
class mdl21_db_abstract
{
 ...
 {
  return insert_record($a, $this->fix_array_params($b));
 }
 ...
 {
  return update_record($t, $this->fix_array_params($params));
 }
 ...
 private function fix_array_params($b)
 {
  $new_recs=array();
  foreach ($b as $key => $value)
   $new_recs[$key]=addslashes($value);
